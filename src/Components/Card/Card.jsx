...
import cardSpeciesStrengthWeakness from '../../Data/Card/cardSpeciesStrengthAndWeakness';
...
const Card = ({ cardName, cardSpecies, cardAttackPoints, cardDefensePoints, cardHealthStatus, cardGenderIcon, cardImage, cardHomeLocation, cardFaceDownPosition, cardAttackPosition }) => {
 ...
 return (
  <div className='findCard-card ml-8' style={{ background: cardSpeciesColors[cardSpecies], padding: "1rem 1.5rem", maxWidth: "10000px", margin: "0 auto" }}>
   ...
   <button onClick={() => console.log(`Card attack: ${cardAttackPoints} \nCard attack  with bonus: ${cardSpeciesStrengthWeakness.Human.strongAgainst.Animal() + cardAttackPoints}`)} style={{ margin: "1rem auto", display: "block", background: "olive", padding: ".5rem 1.5rem", color: "white" }}>Attack</button>
   {/*
